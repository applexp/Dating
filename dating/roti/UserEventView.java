 ...
 */
@WebServlet("/zhs/yonghu/kan")
public class UserEventView extends HttpServlet {
		...
		try{
			...
			if(isUser){
				...
				if(isArticleExist){
					...
					RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/zhs/yonghu/user_view_article.jsp");
