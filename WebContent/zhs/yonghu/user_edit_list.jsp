...
<th style="width: 52% ;text-align: left;">标题</th>
<th style="width: 9% ;text-align: center;">状况</th>
<th style="width: 15% ;text-align: center;">评论量</th>
<th style="width: 15% ;text-align: center;">编辑</th>
</tr>
<% 
	for(int i=0; i< articleList.size(); i++){
		int v = articleList.get(i).getVerify();
%>
<tr index="<%= articleList.get(i).getPostID() %>-<%= i %>">
<td></td>
<td><%= articleList.get(i).getPostID() %></td>
<td><%= articleList.get(i).getTitle() %></td>
<td style="text-align: center;"><% if(v==0){out.print("\u672A\u5BA1\u67E5");}else if(v==1){out.print("\u6279\u51C6");}else if(v==2){out.print("\u4E0D\u901A\u8FC7");} %></td>
<td style="text-align: center;"><%= articleList.get(i).getCommentCount() %></td>
<td style="text-align: center;"><a href="<%= (v==1)?"../../zhs/article?post=":"../../zhs/yonghu/kan?hao=" %><%= articleList.get(i).getPostID() %>" target="__blank"><img src="./../../media/buttonimg/view.png" width=18px height=18px /></a> 
<a href="bianji?hao=<%= articleList.get(i).getPostID() %>"><img src="./../../media/buttonimg/edit.png" width=18px height=18px /></a> <img onclick="cD('shanchu?lei=yige&hao=<%= articleList.get(i).getPostID() %>')" src="./../../media/buttonimg/minus.png" width=18px height=18px style="cursor:pointer;" /></td>
</tr>
<%	} %>
</table>
</form>
...
<h3>用户上传管理</h3>
<ul>
<li><a href="shangchuan"><span class="ltc">活动推文</span></a></li>
<li><a href="liebiao"><span class="xin-selected-option">活动列表</span></a></li>
