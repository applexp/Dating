...
<th style="width: 61% ;text-align: left;">标题</th>
<th style="width: 15% ;text-align: center;">评论量</th>
<th style="width: 13% ;text-align: center;">编辑</th>
</tr>
<% 
...
<td style="text-align: center;"><a href="../../zhs/yonghu/kan?hao=<%= articleList.get(i).getPostID() %>" target="__blank"><img src="./../../media/buttonimg/view.png" width=18px height=18px /></a> 
<a href="bianji?hao=<%= articleList.get(i).getPostID() %>"><img src="./../../media/buttonimg/edit.png" width=18px height=18px /></a> <img onclick="recoveryD('xianshi?lei=yige&hao=<%= articleList.get(i).getPostID() %>')" src="./../../media/buttonimg/plus.png" width=18px height=18px style="cursor:pointer;" /> <img onclick="delD('xianshi?lei=shanchu&hao=<%= articleList.get(i).getPostID() %>')" src="./../../media/buttonimg/delete.png" width=18px height=18px style="cursor:pointer;" /></td>
</tr>
<%	} %>
</table>
</form>
...
<li><a href="huishou"><span class="xin-selected-option">回收站</span></a></li>
</ul>
</div>
