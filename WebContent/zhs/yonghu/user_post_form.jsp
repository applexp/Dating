...
<div id="xin-setting-menu"><ol><%= (role.equals("1"))? "<li><a href=\"../admin/index\">系统管理</a></li>":"" %><li><a href="shangchuan">活动推文</a></li><li><a href="../yonghu/shezhi">账户设置</a></li><li><a href="../logout">退出</a></li></ol></div>
</div>
<div style="clear: both;"></div>
...
<div id="settings-left-content" bumen="tuiwen">
<%
	if(success_upload_event.equals("1")){
%>
<div class="notify"><p class="notify-green">推文或活动上传成功<span class="x-mark x-login-page">&#x2717;</span></p></div>
<%	}else if(success_upload_event.equals("0")){
%>
<div class="notify"><p class="notify-red">推文或活动上传失败<span class="x-mark x-login-page">&#x2717;</span></p></div>
<%  } %>
<h3>上传推文或活动</h3>
<div id="xin-table-login" style="!padding:10px;">
<form action="shangchuan?type=form_submit" method="post" enctype="multipart/form-data" onsubmit="readySubmit();">
<table class="image-editor">
<tr><td class="xin-table-td-size"><label>格式</label></td><td> <div id="radio" style="padding: 5px;"> <input type="radio" id="radio1" name="radio" checked="checked"><label for="radio1" >创建文章</label> <input type="radio" id="radio2" name="radio" ><label for="radio2">创建活动</label></div></tr>
...
<tr><td class="xin-table-td-size"><label>简短描述</label></td><td><input class="xin-table-td-size-input" id="shortdesc" type="text" name="shortdesc" maxlength="119" size="60"  required></td></tr>
<tr><td class="xin-table-td-size"><label>封面</label></td><td><input type="file"  id="cropit-image-input-size" class="cropit-image-input xin-table-td-size-input" required><span id="alert-img-size">图片不能超过5MB</span></td></tr>
...
<tr><td class="xin-table-td-size"><label>内容</label></td><td><input class="xin-table-td-size-input" type="file" name="uploadify_file_upload" id="file_upload"  /></td></tr>
<tr><td class="xin-table-td-size"><label></label></td><td><textarea name="tinyMCE_event_content" id="tinyMCE" style="width:680px;height: 500px; max-width:680px;">Your content here.</textarea></td></tr>
<tr><td class="xin-table-td-size"><label></label></td><td><br/></td></tr>
<tr><td class="xin-table-td-size"><label style="display:none;">类型</label></td><td><select  style="display:none;" name="event_type" required><option value="100" selected="selected">无</option></select></td></tr>
<tr><td class="xin-table-td-size" style="vertical-align: top;"><label>标签</label></td><td><input id="tags" name="tag" type="text" class="tags xin-table-td-size-input" value="爱聚" maxlength="199"></td></tr>
<tr><td class="xin-table-td-size"><label class="shiWenZhang">有售票？</label></td><td><input class="shiWenZhang xin-table-td-size-input" type="checkbox" id="ticket" name="isTicket" value="false"></td></tr>
<tr><td class="xin-table-td-size"><label></label></td><td><div class="hidden" id="payment_url_label"> <label class="shiWenZhang_link">售票链接</label><input class="shiWenZhang_link xin-table-td-size-input" type="text" id="payment_url" name="url" value="n" ><small class="shiWenZhang_link" >http://www.aijunyc.com/zhs/index</small></div></td></tr>
<tr><td class="xin-table-td-size"><label class="shiWenZhang">需时间地点？</label></td><td class="shiWenZhang"><div class="onoffswitch"> <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox xin-table-td-size-input" value="false" id="datetime_addr_switch">  <label class="onoffswitch-label" for="datetime_addr_switch"> <span class="onoffswitch-inner"></span><span class="onoffswitch-switch"></span> </label> </div></td></tr>
<tr><td class="xin-table-td-size"><label class="time_addr hidden" >场地名字</label></td><td><div class="time_addr hidden"><input class="xin-table-td-size-input" type="text" id="eventplacename" name="eventplacename" value=""></div></td></tr>
<tr><td class="xin-table-td-size"><label class="time_addr hidden">时间</label></td><td><div  class="time_addr hidden"><input class="xin-table-td-size-input" type="text" id="event_datetime_start" name="datetime_start" value="" placeholder="开始"/><input type="text" id="event_datetime_end" name="datetime_end" value="" placeholder="结束"/></div></td></tr>
<tr><td class="xin-table-td-size"><label class="time_addr hidden">邮区编号</label></td><td><input  class="time_addr hidden xin-table-td-size-input" type="text" id="zip" name="zip" placeholder="10025" size="5" maxlength="5"></td></tr>
<tr><td class="xin-table-td-size"><label id="city" class="hidden" >城市</label></td><td><div id="city"  class="hidden"><input class="xin-table-td-size-input" type="text" id="city_input" name="city_name" value=""></div></td></tr>
<tr><td class="xin-table-td-size"><label id="city_abbr" class="hidden" >州</label></td><td><div id="city_abbr" class="hidden"><input class="xin-table-td-size-input" type="text" id="city_abbr_input" name="city_abbr" value=""></div></td></tr>
<tr><td class="xin-table-td-size"><label id="country" class="hidden" >国家</label></td><td><div id="country" class="hidden"><input class="xin-table-td-size-input" type="text" id="country_input" name="country" value=""></div></td></tr>
<tr><td class="xin-table-td-size"><label class="time_addr hidden">地址</label></td><td><input class="time_addr hidden xin-table-td-size-input" type="text" id="address" name="Address" placeholder="124 Broadway"></td></tr>
...
<tr><td class="xin-table-td-size"><label id="latlonglb" class="hidden">经纬度</label></td><td><div id="latlongtd" class="hidden">纬度<input class="xin-table-td-size-input" id="lat_box" name="latitude" value="-1" readonly>经度<input class="xin-table-td-size-input" id="lng_box" name="longitude" value="-1" readonly></div></td></tr>
<tr><td></td><td style="padding-top: 20px;"><input type="hidden" name="userid" value="<%= userid %>" ><input id="geshi" type="hidden" name="geshi" value="1" ><input type="hidden" name="username" value="<%= name %>" ><input type="hidden" name="imggroupid" value="<%= photogroupid %>" ><input type="hidden" id="imggroupidpath-id" name="imggroupidpath" value="<%= imageGroupIDPath %>" ><textarea name="profileImage" class="current-image" style="display:none;"></textarea><input type="submit" value="应用" style="width:auto;"></td></tr>
</table>
</form>
</div>
</div>
...
<h3>用户上传管理</h3>
<ul>
<li><a href="shangchuan"><span class="xin-selected-option">活动推文</span></a></li>
...
<script type="text/javascript" src="./../../static/javascript/bibi/tinymce.min.js"></script><!-- TextEditor -->
<script>
...
tinyMCE.init({
	...
	toolbar1 : "save | image media | bold italic underline strikethrough | justifyleft justifycenter justifyright justifyfull styleselect formatselect | fontselect fontsizeselect | forecolor backcolor emoticons | spellchecker preview",
...
$(document).ready(function() {
	...
	$("#file_upload").uploadify({
		...
		'uploader'	: 'shangchuan?type=uploadify_photos&imgspath=' + imgspath,
...
$(function() {
	  $('.image-editor').cropit({
	    imageState: {
	      src: 'https://s3.amazonaws.com/aiju-cloudfront-bucket/default_image/ajuploadimg.png'
	    }
	  });
	});
...
$(document).ready(function() {
	...
	$('#radio1').click(function() {
		  if($('#radio1').is(':checked')) { 
			    $('#geshi').val("1");
			    $('.shiWenZhang').css({'display':'none'});
			    //$('.shiWenZhang_link').css({'display':'none'});
			    $('#payment_url_label').hide();
			    $('#payment_url').val('n');
			    $(".time_addr").hide("slow");
				$("#zip, #eventplacename, #event_datetime_start, #event_datetime_end, #address").prop('required',false);
				...
				$('#datetime_addr_switch').prop('checked', false);
				
				datetime_addr_switch_state = 1;
		}
	});
	$('#radio2').click(function() {
		if($('#radio2').is(':checked')) { 
			$('#geshi').val("2");  
			$('.shiWenZhang').css({'display':'initial'});
			$('#ticket').prop('checked', false);
		}
	});
	...
	if(localStorage.getItem('pObject') !== null) {
		...
		//alert(rData.contents);
		$("#tinyMCE").val(rData.contents);
