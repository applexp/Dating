...
<meta charset="UTF-8">
<meta name="keywords" content="爱聚纽约" >
<meta name="description" content="爱聚纽约">
...
<div id="xin-lower-nav"><div style="float: left; "><ol><li><a href="target?type=event&g=a"><span>活动</span></a> </li><%= (!article.getPurchaseLink().equals("n"))? "<li><span style=\"color: yellow; font-weight: bold;\">&middot;</span> <a href=\""+ articlePurchaseLink +"\" target=\"_blank\"><span>购票网址</span></a> </li>": "" %></ol></div>
...
<script>
	...
	if(width >= 992){}else{$("p span" ).css( "font-size", "40px" );}
	
	var en = '<%= article.getCoverImage() %>';
	//var imgUrl = encodeURI(en)+'';
