...
<th style="width: 65% ;text-align: left;">标题</th>
<th style="width: 15% ;text-align: center;">阅读/评论量</th>
...
<td style="text-align: center;"><%= articleList.get(i).getViewCount() %>/<%= articleList.get(i).getCommentCount() %></td>
<td style="text-align: center;"><a href="../../zhs/admin/kan?hao=<%= articleList.get(i).getPostID() %>" target="__blank"><img src="./../../media/buttonimg/view.png" width=18px height=18px /></a> 
<a href="bianji?hao=<%= articleList.get(i).getPostID() %>"><img src="./../../media/buttonimg/edit.png" width=18px height=18px /></a> <img onclick="recoveryD('xianshi?lei=yige&hao=<%= articleList.get(i).getPostID() %>')" src="./../../media/buttonimg/plus.png" width=18px height=18px style="cursor:pointer;" /></td>
</tr>
<%	} %>
</table>
</form>
