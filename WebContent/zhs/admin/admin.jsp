...
<tr><td class="xin-table-td-size"><label>格式</label></td><td> <div id="radio" style="padding: 5px;"> <input type="radio" id="radio1" name="radio" checked="checked"><label for="radio1" >编写文章</label> <input type="radio" id="radio2" name="radio" ><label for="radio2">创建活动</label></div></tr>
...
<tr><td class="xin-table-td-size"><label></label></td><td><textarea name="tinyMCE_event_content" id="tinyMCE" style="width:680px;height: 500px; max-width:680px;"></textarea></td></tr>
<tr><td class="xin-table-td-size"><label></label></td><td><br/></td></tr>
<tr><td class="xin-table-td-size"><label>类型</label></td><td>
...
<ul>
<li><a href="index"><span class="xin-selected-option">活动推文</span></a></li>
...
<script type="text/javascript" src="./../../static/javascript/bibi/jquery.uploadify.js"></script>
<script type="text/javascript" src="./../../static/javascript/bibi/tinymce.min.js"></script>
<script>
...
$(document).ready(function() {
	...
	$("#file_upload").uploadify({
		...
		'uploader'	: 'index?type=uploadify_photos&imgspath=' + imgspath,
