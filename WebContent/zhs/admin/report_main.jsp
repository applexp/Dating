<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import = "roti.__Reports"%>
<%@page import="java.util.List"%>
<%@page import="java.util.ArrayList"%>
<% 
	String role = (String) request.getAttribute("role"); 
	List<__Reports> reportList = new ArrayList<__Reports>();
	reportList = (List <__Reports>) request.getAttribute("reportList");
	__Reports report = (__Reports) request.getAttribute("report"); 
%>
<!DOCTYPE html>
<html>
<head>
...
<tr><td style="width: 25% ;text-align: left;">目前所有用户的数目: </td><td style="width: 75% ;text-align: left;"><%= report.getTotalAddUser()-14 %> 个用户</td></tr>
<tr><td>目前所有文章活动的数目: </td><td><%= report.getTotalAddPost() %> 个文章活动</td></tr>
<tr><td>目前所有评论的数目: </td><td><%= report.getTotalAddComment() %> 个评论</td></tr>
</table>
<br/><br/>
...
<th style="width: 20% ;text-align: left;">日</th>
<th style="width: 78% ;text-align: left;">数量</th>
</tr>
<% 
...
<tr>
<td></td>
<td><%= reportList.get(i).getCreatedDate() %></td>
<td><%= reportList.get(i).getValue() %></td>
</tr>
<%	} %>
</table>
</div>
...
<li style="cursor:default;">__________</li>
<li><a href="zonghe-baogao?type=day_user"><span class="xin-selected-option">综合报告</span></a></li>
</ul>
</div>
