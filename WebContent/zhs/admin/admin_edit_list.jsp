...
<td style="text-align: center;"><a href="../../zhs/article?post=<%= articleList.get(i).getPostID() %>" target="__blank"><img src="./../../media/buttonimg/view.png" width=18px height=18px /></a> 
